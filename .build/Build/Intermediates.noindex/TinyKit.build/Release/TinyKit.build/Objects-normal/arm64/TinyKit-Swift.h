...
#ifndef TINYKIT_SWIFT_H
#define TINYKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TinyKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7TinyKit16LineNumberGutter")
...
SWIFT_CLASS("_TtC7TinyKit12TinyTextView")
@interface TinyTextView : NSTextView
